...
(window.averta = {}),
    (function ($) {
        ...
        if (
            ...
            (window.isMSIE = function (version) {
                ...
                if (!version) return !0;
                var ieVer = $.browser.version.slice(
                    0,
        ...
        (p.getDirection = function (new_x, new_y) {
            ...
            (p.createStatusObject = function (evt) {
                ...
                return (
                    ...
                    (status_data.direction = this.getDirection(
                        evt.pageX,
                        evt.pageY,
                    )),
                    status_data
    ...
    (function () {
        ...
        (p.to = function (callback, target) {
            ...
            (p.from = function (callback, target) {
                return (
                    (this.fr_cb = callback), (this.fr_cb_target = target), this
                );
            }),
            (p.onComplete = function (callback, target) {
                return (
                    (this.oc_fb = callback), (this.oc_fb_target = target), this
                );
            }),
            ...
            if (void 0 !== properties.x || void 0 !== properties.y)
                if (_cssanim) {
                    ...
                    if (void 0 !== properties.x) {
                        var posx =
                            'auto' !== element.css('right') ? 'right' : 'left';
                        (properties[posx] = properties.x + 'px'),
                            delete properties.x;
                    }
                    if (void 0 !== properties.y) {
                        var posy =
                            'auto' !== element.css('bottom') ? 'bottom' : 'top';
        ...
        (p.changeTo = function (value, animate, speed, snap_num, dispatch) {
            if (
                ...
                var self = this,
                    ...
                    timeconst =
                        animFrict +
                        ((speed - 20) * animFrict * 1.3) /
                            self.options.maxSpeed,
                    tick = function () {
            ...
            (p._calculateExtraMove = function (value) {
                ...
                return m < this.options.snapsize / 2
                    ? -m
                    : this.options.snapsize - m;
            }),
            ...
            (p._callrenderer = function () {
                this.__renderHook &&
                    this.__renderHook.fun.call(
                        this.__renderHook.ref,
                        this,
                        this.value,
                    );
            }),
            ...
            (p._computeDeceleration = function () {
                ...
                if (
                    ...
                    this.value < this._min_value
                        ...
                        (this.__isout =
                            Math.abs(out_value) >= this.options.minValidDist),
                        this.__isout &&
                            (this.__speed * out_value <= 0
                                ? (this.__speed +=
                                      out_value * this.options.outFriction)
                                : (this.__speed =
                                      out_value *
                    ...
                    var self = this,
                        tick = function () {
                            self._deceleration &&
                                ...
                                Math.abs(self.__speed) >
                                    self.options.minValidDist || self.__isout
                                    ? window.requestAnimationFrame(tick)
    ...
    (function (window, document, $) {
        window.MSLayerController = function (slide) {
            (this.slide = slide),
                ...
                (this.$staticLayers =
                    $('<div></div>').addClass('ms-static-layers')),
                (this.$fixedLayers =
                    $('<div></div>').addClass('ms-fixed-layers')),
                (this.$animLayers =
                    $('<div></div>').addClass('ms-anim-layers'));
        };
        ...
        (p.addLayer = function (layer) {
            ...
            (p.showLayers = function () {
                this.layersHideTween && this.layersHideTween.stop(!0),
                    this.fixedLayersHideTween &&
                        this.fixedLayersHideTween.stop(!0),
                    this._resetLayers(),
            ...
            (p.setSize = function (width, height, hard) {
                if (
                    ...
                    var left =
                        Math.max(0, (width - this.slider.options.width) / 2) +
                        'px';
                ...
                (_2d = window._css2d && window._cssanim && !o),
                    ...
                    (st.t = window._css3d
                        ? function (
                              ...
                              'n' !== tx &&
                                  (transform +=
                                      'translateX(' + tx * st.rf + 'px) '),
                                  'n' !== ty &&
                                      (transform +=
                                          'translateY(' + ty * st.rf + 'px) '),
                                  'n' !== tz &&
                                      (transform +=
                                          'translateZ(' + tz * st.rf + 'px) '),
                                  'n' !== r &&
                                  ...
                                  'n' !== skx &&
                                      (transform += 'skewX(' + skx + 'deg) '),
                                  'n' !== sky &&
                                      (transform += 'skewY(' + sky + 'deg) '),
                                  'n' !== scx &&
        ...
        (p.setStartAnim = function (anim) {
            ...
            (p.create = function () {
                if (
                    ...
                    (this.staticLayer =
                        'static' === this.$element.data('position')),
                    (this.fixedLayer =
                        'fixed' === this.$element.data('position')),
            ...
            (p.start = function () {
                if (!this.isShowing && !this.staticLayer) {
                    ...
                    var effect_css = MSLayerEffects[
                            this.start_anim.eff_name
                        ].apply(
                            null,
                    ...
                    for (key in effect_css)
                        this._checkPosKey(key, effect_css) ||
                            (null != MSLayerEffects.defaultValues[key] &&
                                (start_css_eff[key] =
                                    MSLayerEffects.defaultValues[key]),
                            key in this.baseStyle &&
                                ...
                                this.centerAlign &&
                                    ...
                                    (base +=
                                        ...
                                        2),
                                (effect_css[key] =
                                    base + parseFloat(effect_css[key]) + 'px'),
                    ...
                    clearTimeout(this.to),
                        ...
                        (this.clTo = setTimeout(function () {
                            that.show_cl = !0;
                        }, (this.start_anim.delay || 0.01) +
                            this.start_anim.duration)),
                        this.autoHide &&
            ...
            (p._parseEffParams = function (params) {
                for (
                    var eff_params = [], i = 0, l = params.length;
                    l > i;
                    ++i
                ) {
                    var value = params[i];
        ...
        (p._showTT = function () {
            ...
            (p._locateTT = function () {
                ...
                (this.pos_x =
                    os.left -
                    os2.left -
                    this.slide.slider.$element.scrollLeft()),
                    (this.pos_y =
                        os.top -
                        os2.top -
                        this.slide.slider.$element.scrollTop()),
                    (this.from = { opacity: 0 }),
                    (this.to = { opacity: 1 }),
                ...
                switch (this.align) {
                    ...
                    case 'right':
                        (this.base_l = this.pos_x + arrow_w + space),
                            (this.base_t =
                                this.pos_y - this.tt.outerHeight(!1) / 2),
                            window._css3d
                                ? ((this.from[window._jcsspfx + 'Transform'] =
                                      'translateX(' + dist + 'px)'),
                                  (this.to[window._jcsspfx + 'Transform'] = ''))
        ...
        (p.onSwipeStart = function () {
            ...
            (p.setupBG = function () {
                !this.initBG &&
                    ...
                    (this.bgWidth =
                        this.bgNatrualWidth || this.$bg_img.width()),
                    (this.bgHeight =
                        this.bgNatrualHeight || this.$bg_img.height()),
            ...
            (p.setBGVideo = function ($video) {
                if ($video[0].play) {
                    ...
                    $video.addClass('ms-slide-bgvideo'),
                        ...
                        $video.data('autopause') === !0 &&
                            (this.autoPauseBgVid = !0),
                        (this.bgvideo_fillmode =
                            $video.data('fill-mode') || 'fill'),
            ...
            (p.__playVideo = function () {
                this.vplayed ||
                    ...
                    this.slider.api.paused ||
                        (this.slider.api.pause(), (this.roc = !0)),
                    ...
                    this.video &&
                        ...
                        window._touch &&
                            this.vcbtn
                                ...
                                .append(
                                    '<div class="ms-vcbtn-txt">Close video</div>',
                                )
                                .appendTo(this.view.$element.parent())),
                    !this.slider.options.autoHeight &&
                        this.hasBG &&
                        (this.$imgcont.css('height', '100%'),
                        ('center' === this.fillMode ||
    ...
    (function ($) {
        ...
        (p.setupView = function () {
            ...
            var viewClass =
                SliderViewList[this.slider.options.view] || MSBasicView;
            if (
                (!viewClass._3dreq ||
            ...
            (p.onTimer = function () {
                if (
                    (this._timer.getTime() >=
                        1e3 * this.view.currentSlide.delay &&
                        (this.skipTimer(),
                        this.view.next(),
                        (this.hideCalled = !1)),
                    (this._delayProgress =
                        this._timer.getTime() /
                        (10 * this.view.currentSlide.delay)),
                    this.so.hideLayers &&
                        !this.hideCalled &&
                        1e3 * this.view.currentSlide.delay -
                            this._timer.getTime() <=
                    ...
                    this.slider.$controlsCont &&
                        ...
                        this.view.$element.css(
                            ...
                            Math.min(
                                0,
                                -(
                                    this.slider.$element[0].clientWidth -
                                    this.so.width
                                ) / 2,
                            ) + 'px',
                        ),
                    this.dispatchEvent(
                        new MSSliderEvent(MSSliderEvent.RESIZE),
                    ));
            }),
            ...
            (p.setup = function () {
                (this.created = !0),
                    ...
                    (this.currentSlide =
                        this.view.slideList[this.so.start - 1]),
                    this.__resize();
                var slideInHash = this.__curentSlideInHash(),
                    startSlide =
                        -1 !== slideInHash ? slideInHash : this.so.start - 1;
                if (
            ...
            (p.update = function (hard) {
                this.slider.init_safemode &&
                    hard &&
                    (this.slider.init_safemode = !1),
                    this.__resize(hard),
                    hard &&
                        this.dispatchEvent(
                            new MSSliderEvent(MSSliderEvent.HARD_UPDATE),
                        );
            }),
            (p.locate = function () {
                this.__resize();
    ...
    (function ($) {
        ...
        (p.__setupSlides = function () {
            ...
            (p.__createSlideLayers = function (slide, layers) {
                0 != layers.length &&
                    ...
                    layers.each(function (index, domEle) {
                        ...
                        'A' === domEle.nodeName &&
                            'image' ===
                                $layer_element.find('>img').data('type') &&
                            (($parent_ele = $(this)),
                            ($layer_element = $parent_ele.find('img')));
                        var layer = new LayerTypes[
                            $layer_element.data('type') || 'text'
                        ]();
                        ...
                        void 0 !== $layer_element.data('effect') &&
                            ...
                            void 0 !== $layer_element.data('ease') &&
                                (eff_parameters.ease =
                                    $layer_element.data('ease')),
                            void 0 !== $layer_element.data('duration') &&
                                (eff_parameters.duration =
                                    $layer_element.data('duration')),
                            void 0 !== $layer_element.data('delay') &&
                                (eff_parameters.delay =
                                    $layer_element.data('delay')),
                            $layer_element.data('hide-effect') &&
                                (end_eff_parameters.name =
                                    $layer_element.data('hide-effect')),
                            $layer_element.data('hide-ease') &&
                                (end_eff_parameters.ease =
                                    $layer_element.data('hide-ease')),
                            ...
                            void 0 !== $layer_element.data('hide-time') &&
                                (end_eff_parameters.time =
                                    $layer_element.data('hide-time')),
            ...
            (p._setupSliderLayout = function () {
                ...
                'boxed' !== lo &&
                    'partialview' !== lo &&
                    (this.options.fullwidth = !0),
                    ('fullscreen' === lo || 'autofill' === lo) &&
                        ((this.options.fullheight = !0),
                        'autofill' === lo &&
                            ((this.$autofillTarget = $(
                                this.options.autofillTarget,
                            )),
            ...
            (p._updateLayout = function (event) {
                ...
                var margin =
                    -$element.offset().left + that.leftSpace + that.lastMargin;
            ...
            (p.reserveSpace = function (side, space) {
                var sideSpace = side + 'Space',
                    pos = this[sideSpace];
                return (
                    (this[sideSpace] += space), this._updateSideMargins(), pos
                );
            }),
            ...
            (p.control = function (control, options) {
                if (control in MSSlideController.SliderControlList) {
                    ...
                    var ins = new MSSlideController.SliderControlList[control](
                        options,
                    );
            ...
            (p.setup = function (target, options) {
                if (
                    ...
                    for (var i = 0, l = MS._plugins.length; i !== l; i++) {
                        ...
                        -1 ===
                            this.options.disablePlugins.indexOf(plugin.name) &&
                    ...
                    return this.each(function () {
                        $.data(this, plugin) ||
                            $.data(
                                this,
                                plugin,
                                new MasterSliderPlugin(this, options),
                            );
                    });
                if (
                    ...
                    return (
                        this.each(function () {
                            ...
                            instance instanceof MasterSliderPlugin &&
                                ...
                                instance instanceof MasterSliderPlugin &&
                                    'function' ==
                                        typeof instance._slider.api[options] &&
                                    (returns = instance._slider.api[
                                        options
                                    ].apply(
    ...
    (function ($) {
        ...
        window.MSBasicView = function (options) {
            (this.options = {
                ...
                (this.__translate_end = window._css3d
                    ? ' translateZ(0px)'
                    : ''),
                (this.$slideCont =
                    $('<div></div>').addClass('ms-slide-container')),
        ...
        (p.__snapCompelet = function () {
            ...
            (p.__snapUpdate = function (controller, snap, change) {
                ...
                this._checkCritMargins(),
                    $.browser.mozilla &&
                        ((this.slideList[
                            this.index
                        ].$element[0].style.marginTop = '0.1px'),
                        this.currentSlide &&
            ...
            (p._checkCritMargins = function () {
                if (!this.normalMode) {
                    var hlf = Math.floor(this.options.viewNum / 2),
                        inView = this.viewSlidesList.indexOf(
            ...
            (p.__updateViewList = function () {
                ...
                if (this.loop)
                    ...
                    for (i = 0; i !== hlf && this.index - i !== -1; i++)
                        this.viewSlidesList.unshift(
                            this.slideList[this.index - i],
                        );
                    for (
                        i = 1;
                        i !== hlf && this.index + i !== this.slidesCount;
                        i++
                    )
                        this.viewSlidesList.push(
                            this.slideList[this.index + i],
            ...
            (p.__locateSlides = function (move, start) {
                ...
                for (
                    var slide, l = this.viewSlidesList.length, i = 0;
                    i !== l;
                    i++
                ) {
                    var pos =
                        start + i * (this[this.__dimension] + this.spacing);
            ...
            (p.__createLoopList = function () {
                var return_arr = [],
                    ...
                    before_count =
                        this.slidesCount % 2 === 0
                            ? count - 1
                            : Math.floor(count),
                    after_count =
                        this.slidesCount % 2 === 0 ? count : Math.floor(count);
                for (
                    this.currentSlideLoc = before_count, i = 1;
                    before_count >= i;
                    ++i
                )
                    return_arr.unshift(
            ...
            (p.__updateSlidesZindex = function () {
                ...
                if (this.loop)
                    for (
                        var loc = this.viewSlidesList.indexOf(
                                this.currentSlide,
                            ),
                            i = 0;
                        i !== l;
    ...
    (function () {
        ...
        (p.__updateSlidesHoriz = function (slide, distance) {
            ...
            (p.__updateSlidesVertic = function (slide, distance) {
                var value = Math.abs((100 * distance) / this.__width),
                    rvalue =
                        Math.min(0.3 * value, 30) * (0 > distance ? -1 : 1),
                    zvalue = 1.2 * value;
                slide.$element[0].style[window._jcsspfx + 'Transform'] =
                    'translateZ(' +
                    5 * -zvalue +
    ...
    (function () {
        ...
        (p.__calculate = function (distance) {
            var value = Math.min(
                    Math.abs((100 * distance) / this.__width),
                    100,
                ),
                ...
                for (
                    ...
                    (this.slides[i].$frame[0].style.width = width + 'px'),
                        slider.options.autoHeight ||
                            (this.slides[i].$frame[0].style.height =
                                height + 'px');
        ...
        (p.__updateSlidesHoriz = function (slide, distance) {
            ...
            (p.__updateSlidesVertic = function (slide, distance) {
                ...
                slide.hasBG &&
                    slide.$bg_img.css(
                        'opacity',
                        (100 - Math.abs((120 * distance) / this.__width / 3)) /
                            100,
                    ),
                    slide.$element.css(
                        window._csspfx + 'transform',
    ...
    (function ($) {
        ...
        var MSThumblist = function (options) {
            BaseControl.call(this),
                ...
                (this.__alignsize =
                    'h' === this.options.dir ? 'height' : 'width'),
                (this.__jdimen =
            ...
            (p.slideAction = function (slide) {
                var thumb_ele = slide.$element.find('.ms-thumb'),
                    ...
                    thumb_frame = $('<div></div>')
                        ...
                        .bind(
                            this.options.hover ? 'hover' : 'click',
                            function () {
                    ...
                    if ('start' === phase) this.controller.stop();
                        ...
                        speed > 0.1
                            ? this.controller.push(
                                  ((-status.distanceY / status.duration) * 50) /
                                      3,
                              )
                            : ((this.click_enable = !0),
                              this.controller.cancel());
            ...
            (p.horizSwipeMove = function (status) {
                if (!this.dTouch) {
                    ...
                    if ('start' === phase)
                        ...
                        speed > 0.1
                            ? this.controller.push(
                                  ((-status.distanceX / status.duration) * 50) /
                                      3,
                              )
                            : ((this.click_enable = !0),
                              this.controller.cancel());
            ...
            (p.updateThumbscroll = function () {
                ...
                if (
                    ...
                    var first_snap =
                        this.cindex -
                        Math.floor(
                            this.$element[this.__dimen]() / this.thumbSize,
                        ) +
                        1;
    ...
    (function ($) {
        ...
        (p.setup = function () {
            ...
            (p.create = function () {
                ...
                'h' === this.options.dir
                    ? this.$element.width(
                          bullet.outerWidth(!0) * this.slider.api.count(),
                      )
                    : this.$element.css(
                          'margin-top',
                ...
                if (this.lvalue !== value) {
                    ...
                    return 0 > value
                        ...
                        : (value > this.vdimen - this.bar_dimen &&
                              (this.$bar[0].style[this.__dimen] =
                                  this.vdimen - value + 'px'),
                          window._cssanim
                              ? void (this.$bar[0].style[
                                    ...
                                    'px)' +
                                    this.__translate_end)
                              : void (this.$bar[0].style[this.__pos] =
                                    value + 'px'));
                }
            }),
            (p.destroy = function () {
            ...
            return (
                ...
                this.$canvas[0].getContext
                    ? ((this.ctx = this.$canvas[0].getContext('2d')),
                      (this.prog = 0),
                      (this.__w =
                          2 * (this.options.radius + this.options.stroke / 2)),
            ...
            (p.switchEle = function (ele) {
                if (this.current_ele) {
                    this.current_ele[0].tween &&
                        this.current_ele[0].tween.stop(!0),
    ...
    (function ($) {
        'use strict';
        (window.MSScrollParallax = function (
            slider,
            parallax,
            bgparallax,
            fade,
            ...
            (p.updateSlidesBG = function (pos, fixed) {
                for (
                    var slides = this.slider.api.view.slideList,
                        position =
                            !fixed || $.browser.msie || $.browser.opera
                                ? ''
                                : 'fixed',
                        i = 0,
                        l = slides.length;
                    ...
                    slides[i].hasBG &&
                        ...
                        slides[i].$bgvideocont &&
                            ((slides[i].$bgvideocont[0].style.position =
                                position),
                ...
                (this.filters = this.slider.options.filters),
                    ...
                    (this.target =
                        'slide' === this.slider.options.filterTarget
                            ? '$element'
                            : '$bg_img'),
                    (this.filterName = $.browser.webkit
                        ? 'WebkitFilter'
                        : 'filter');
                ...
                _scrollToEnd = function (duration) {
                    ...
                    null == duration && (duration = 1.4),
                        $('html, body').animate(
                            {
                                scrollTop:
                                    sliderEle.offset().top +
                                    sliderEle.outerHeight(!1),
                            },
                            1e3 * duration,
                            'easeInOutQuad',
                        );
