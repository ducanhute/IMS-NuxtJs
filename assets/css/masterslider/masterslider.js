    ...
    averta.EventDispatcher.prototype = {
        ...
        dispatchEvent: function (event) {
            ...
            if (this.listeners[event.type]) {
                for (
                    var i = 0, l = this.listeners[event.type].length;
                    i < l;
                    ++i
                ) {
    ...
    function transPos(element, properties) {
        if (properties.x !== undefined || properties.y !== undefined) {
            if (_cssanim) {
                ...
                if (properties.x !== undefined) {
                    var posx =
                        element.css('right') !== 'auto' ? 'right' : 'left';
                ...
                if (properties.y !== undefined) {
                    var posy =
                        element.css('bottom') !== 'auto' ? 'bottom' : 'top';
    ...
    p.changeTo = function (value, animate, speed, snap_num, dispatch) {
        ...
        if (animate) {
            ...
            var tick = function () {
                ...
                if (
                    Math.abs(dis) > self.options.minValidDist &&
                    self.animating
                ) {
    ...
    p._locateTT = function () {
        ...
        switch (this.align) {
            case 'top':
                ...
                this.base_t =
                    this.pos_y - this.tt.outerHeight(false) - arrow_h - space;
            ...
            case 'left':
                this.base_l =
                    this.pos_x - arrow_w - this.tt.outerWidth(false) - space;
                this.base_t = this.pos_y - this.tt.outerHeight(false) / 2;
...
(function ($) {
    ...
    p.runAction = function (action) {
        ...
        if (action in this) {
            ...
            console.log(
                'Master Slider Error: Action "' + action + '" not found.',
            );
        }
    };
...
(function ($) {
    ...
    p.__setupSlides = function () {
        ...
        this.$element.children('.ms-slide').each(function (index) {
            ...
            new_slide.delay =
                $slide_ele.data('delay') !== undefined
                    ? $slide_ele.data('delay')
                    : 3;
            new_slide.fillMode =
    ...
    p.setup = function (target, options) {
        ...
        if ($.browser.msie) {
            this.$element
                ...
                .addClass(
                    'ms-ie' +
                        $.browser.version.slice(
                            0,
                            $.browser.version.indexOf('.'),
                        ),
                );
        } else if ($.browser.webkit) {
...
(function ($) {
    ...
    p.__createLoopList = function () {
        ...
        var after_count =
            this.slidesCount % 2 === 0 ? count : Math.floor(count);
...
(function ($) {
    ...
    p.create = function () {
        ...
        if (this.options.dir === 'h') {
            this.$element.width(
                bullet.outerWidth(true) * this.slider.api.count(),
            );
        } else {
            this.$element.css(
                'margin-top',
                -this.$element.outerHeight(true) / 2,
            );
        }
    ...
    p.moveParallax = function (e) {
        ...
        if (out <= 0) {
            ...
            if (layers && that.fade) {
                layers.css(
                    'opacity',
                    1 - Math.min(1, -out / slider.api.height),
                );
            }
        } else {
            if (layers) {
...
(function (document, window, jQuery) {
    ...
    p.init = function () {
        ...
        this.target =
            this.slider.options.filterTarget === 'slide'
                ? '$element'
                : '$bg_img';
...
(function ($, document, window) {
    ...
    var _scrollToEnd = function (duration) {
        ...
        $('html, body').animate(
            {
                scrollTop:
                    sliderEle.offset().top + sliderEle.outerHeight(false),
            },
            duration * 1000,
            'easeInOutQuad',
        );
